 ...
 */
public class EditViagem extends javax.swing.JFrame 
{
    Viagem V = new Viagem();
    ...
    private void initComponents() {
        ...
        BotãoEditarrV = new javax.swing.JButton();
        BotãoCanEditV = new javax.swing.JButton();
        ...
        BotãoEditarrV.setFont(new java.awt.Font("Impact", 0, 14)); // NOI18N
        BotãoEditarrV.setText("Editar");
        BotãoEditarrV.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotãoEditarrVActionPerformed(evt);
            }
        });

        BotãoCanEditV.setFont(new java.awt.Font("Impact", 0, 14)); // NOI18N
        BotãoCanEditV.setText("Cancelar");
        BotãoCanEditV.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotãoCanEditVActionPerformed(evt);
            }
        });
        ...
        PainelCadastroLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, PainelCadastroLayout.createSequentialGroup()
                ...
                .addComponent(BotãoEditarrV, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(26, 26, 26)
                .addComponent(BotãoCanEditV, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(97, 97, 97))
        );
        PainelCadastroLayout.setVerticalGroup(
            ...
            .addGroup(PainelCadastroLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(PainelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(BotãoEditarrV, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BotãoCanEditV, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        Titulo.setText("eDITAR de Viagem");
    ...
    // Botoões de Ações
    private void BotãoEditarrVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotãoEditarrVActionPerformed
    ...
    }//GEN-LAST:event_BotãoEditarrVActionPerformed

    private void BotãoCanEditVActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotãoCanEditVActionPerformed
        // Click no Botão Cancelar:
        
        MV.setVisible(true);
        dispose();
        
    }//GEN-LAST:event_BotãoCanEditVActionPerformed
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditViagem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() 
        {
            public void run() 
            {
                new EditViagem().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton BotãoCanEditV;
    private javax.swing.JButton BotãoEditarrV;
