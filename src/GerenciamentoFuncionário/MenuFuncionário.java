...
public class MenuFuncionário extends javax.swing.JFrame 
{
    ...
    private void initComponents() {
        ...
        ScrollTabelaFuncionário = new javax.swing.JScrollPane();
        TabelaFuncionário = new javax.swing.JTable();
        ...
        Titulo.setText("Menu de Funcionários");
        ...
        TabelaFuncionário.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        TabelaFuncionário.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        TabelaFuncionário.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        TabelaFuncionário.setToolTipText("");
        ScrollTabelaFuncionário.setViewportView(TabelaFuncionário);
        ...
        PainelBotõesLayout.setHorizontalGroup(
            ...
            .addGroup(PainelBotõesLayout.createSequentialGroup()
                ...
                .addGroup(PainelBotõesLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(ScrollTabelaFuncionário, javax.swing.GroupLayout.PREFERRED_SIZE, 1016, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(PainelBotõesLayout.createSequentialGroup()
                        .addGap(32, 32, 32)
        ...
        PainelBotõesLayout.setVerticalGroup(
            ...
            .addGroup(PainelBotõesLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(ScrollTabelaFuncionário, javax.swing.GroupLayout.PREFERRED_SIZE, 219, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(61, 61, 61))
        );
    ...
    private void BotãoCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotãoCadastroActionPerformed
        ...
        CadFuncionário CF = new CadFuncionário();
        CF.setVisible(true);
        dispose(); 
    ...
    private void BotãoEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotãoEditarActionPerformed
        ...
        selectedRow = TabelaFuncionário.getSelectedRow();
        if(selectedRow>=0)
        {
            EditFuncionário EdF = new EditFuncionário();
            EdF.setVisible(true);
            dispose();
        }
        else
    ...
    private void BotãoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotãoExcluirActionPerformed
        ...
        if(selectedRow>=0)
        {
            ExclFuncionário ExF = new ExclFuncionário();
            ExF.setVisible(true);
            dispose();
        }
        else
    ...
    private void PesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PesquisarActionPerformed
        ...
        DefaultTableModel TF = (DefaultTableModel)TabelaFuncionário.getModel();
        TF.setNumRows(0);
        ...
        for(int i = 0 ; i<Controle.funcionários.size() ; i++)
        {
            ...
            if(Controle.funcionários.get(i).getCpf().equals(CampoPesquisar.getText()))
            {
                TF.setNumRows(0);
                
                TF.addRow(new Object[]
                {
                        Controle.funcionários.get(i).getNome(),
                        Controle.funcionários.get(i).getCpf(),
                        Controle.funcionários.get(i).getFunção(),
                        Controle.funcionários.get(i).getSalário(),
                        Controle.funcionários.get(i).getComissão(),
                        Controle.funcionários.get(i).getNvoos()
                });
            }
    ...
    */
    ...
    private javax.swing.JScrollPane ScrollTabelaFuncionário;
    private javax.swing.JTable TabelaFuncionário;
