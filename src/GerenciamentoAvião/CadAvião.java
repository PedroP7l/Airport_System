 ...
 */
public class CadAvião extends javax.swing.JFrame 
{
    public CadAvião() 
    {
        initComponents();
    ...
    private void initComponents() {
        ...
        BotãoCadastrarA = new javax.swing.JButton();
        BotãoCanCadasA = new javax.swing.JButton();
        ...
        BotãoCadastrarA.setFont(new java.awt.Font("Impact", 0, 14)); // NOI18N
        BotãoCadastrarA.setText("Cadastrar");
        BotãoCadastrarA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotãoCadastrarAActionPerformed(evt);
            }
        });

        BotãoCanCadasA.setFont(new java.awt.Font("Impact", 0, 14)); // NOI18N
        BotãoCanCadasA.setText("Cancelar");
        BotãoCanCadasA.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BotãoCanCadasAActionPerformed(evt);
            }
        });
        ...
        PainelCadastroLayout.setHorizontalGroup(
            ...
            .addGroup(PainelCadastroLayout.createSequentialGroup()
                .addGroup(PainelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(PainelCadastroLayout.createSequentialGroup()
                        .addGap(131, 131, 131)
                        .addComponent(BotãoCadastrarA, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(26, 26, 26)
                        .addComponent(BotãoCanCadasA, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        PainelCadastroLayout.setVerticalGroup(
            ...
            .addGroup(PainelCadastroLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(PainelCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(BotãoCadastrarA, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(BotãoCanCadasA, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(17, Short.MAX_VALUE))
        );

        getContentPane().add(PainelCadastro);
        PainelCadastro.setBounds(50, 240, 590, 280);

        Titulo.setFont(new java.awt.Font("Airstrike Laser", 0, 45)); // NOI18N
        Titulo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        Titulo.setText("Cadastrar de Avião");
    ...
    // Botoões de Ações
    private void BotãoCadastrarAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotãoCadastrarAActionPerformed
    ...
    }//GEN-LAST:event_BotãoCadastrarAActionPerformed

    private void BotãoCanCadasAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotãoCanCadasAActionPerformed
        // Click no Botão Cancelar:
        
        MA.setVisible(true);
        dispose();
        
    }//GEN-LAST:event_BotãoCanCadasAActionPerformed
    ...
    public static void main(String args[]) 
    {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadAvião.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton BotãoCadastrarA;
    private javax.swing.JButton BotãoCanCadasA;
